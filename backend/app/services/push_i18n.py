...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "voice_message_body": "sent you a voice message",
        "incoming_call_body": "is calling you on a video call!",
        "incoming_call_body_audio": "is calling you!",
        "missed_call_body": "You have 1 missed call",
    ...
    "ko": {
        ...
        "voice_message_body": "음성 메시지를 보냈어요",
        "incoming_call_body": "영상통화를 시도했어요!",
        "incoming_call_body_audio": "전화를 시도했어요!",
        "missed_call_body": "부재중 전화 1통이 있어요",
    ...
    "es": {
        ...
        "voice_message_body": "te envió un mensaje de voz",
        "incoming_call_body": "¡te está llamando por videollamada!",
        "incoming_call_body_audio": "¡te está llamando!",
        "missed_call_body": "Tienes 1 llamada perdida",
    ...
    "zh": {
        ...
        "voice_message_body": "给你发来了一条语音消息",
        "incoming_call_body": "正在给你打视频通话！",
        "incoming_call_body_audio": "正在给你打电话！",
        "missed_call_body": "你有1通未接来电",
    ...
    "ja": {
        ...
        "voice_message_body": "ボイスメッセージを送りました",
        "incoming_call_body": "ビデオ通話をかけています！",
        "incoming_call_body_audio": "電話をかけています！",
        "missed_call_body": "不在着信が1件あります",
