...
const translations = {
  ...
  "hero.eyebrow": {
    ko: "전화번호 인증 회원만의 블라인드 채팅",
    en: "Blind chat, phone-verified members only",
    es: "Chat a ciegas, solo miembros con teléfono verificado",
    zh: "仅限手机号认证会员的盲聊",
    ja: "電話番号認証済み会員限定のブラインドチャット",
  },
  "hero.title": {
  ...
  "hero.subtitle": {
    ko: "관심사가 통하는 진짜 회원과 먼저 대화부터 시작하세요. 이름과 사진은 서로 동의할 때만 공개돼요. 흔한 랜덤 채팅이 아닌, 진짜 인연을 위한 블라인드 매칭입니다.",
    en: "Start talking with real, phone-verified members who share your interests. Names and photos are revealed only when you both agree. Not cheap random chat — real blind matching for real connection.",
    es: "Empieza a conversar con miembros reales, con teléfono verificado, que comparten tus intereses. Los nombres y las fotos solo se revelan si ambos estáis de acuerdo. No es un chat aleatorio cualquiera: es matching a ciegas para conexiones reales.",
    zh: "与兴趣相投、经手机号认证的真实会员先聊起来。姓名和照片只有在双方同意后才会公开。这不是随便的随机聊天，而是为真正缘分打造的盲配对。",
    ja: "趣味が合う、電話番号認証済みの本物のメンバーとまず会話から。名前と写真はお互いが同意したときだけ公開されます。ありがちなランダムチャットではなく、本当の出会いのためのブラインドマッチングです。",
  },
  ...
  "why.3.body": {
    ko: "블라인드 채팅을 시작할 때마다 원하는 성별·나이·거리를 직접 골라요. 기본값은 내 프로필의 관심 성별이고, 바꾸면 한 번 더 확인해줘서 실수할 일이 없어요.",
    en: "Each time you start a Blind Chat, choose the gender, age range and distance you want. It defaults to who you said you're interested in, and asks you to confirm if you change it — so no mix-ups.",
    es: "Cada vez que empiezas un chat a ciegas, eliges el género, el rango de edad y la distancia que quieres. Por defecto usa tu interés del perfil y te pide confirmar si lo cambias, así que no hay confusiones.",
    zh: "每次开始盲聊，都可以自己选择想认识的性别、年龄段和距离。默认使用你个人资料中的意向性别，更改时还会再次确认，不怕选错。",
    ja: "ブラインドチャットを始めるたびに、会いたい性別・年齢・距離を自分で選べます。初期値はプロフィールの希望性別で、変更するときはもう一度確認するので選び間違いもありません。",
  },
  ...
  "feature.7.body": {
    ko: "관심사가 통하는 진짜 회원과 먼저 대화부터 시작하세요. 이름과 사진은 서로 동의할 때만 공개돼요.",
    en: "Start with conversation, not a photo — chat with a real member who shares your interests. Names and photos only go public once both sides agree.",
    es: "Empieza por la conversación, no por la foto: chatea con un miembro real que comparte tus intereses. Los nombres y fotos solo se revelan si ambos están de acuerdo.",
    zh: "先聊天，不看脸——与兴趣相投的真实会员开始匿名对话。只有双方都同意，姓名和照片才会公开。",
    ja: "写真より先に会話から — 趣味が合う本物のメンバーとチャット。名前と写真はお互いが同意したときだけ公開されます。",
  },
  ...
  "feature.11.title": {
    ko: "하루 5번 무료 매칭",
    en: "5 free matches a day",
    es: "5 matches gratis al día",
    zh: "每天5次免费配对",
    ja: "毎日5回の無料マッチ",
  },
  "feature.11.body": {
  ...
  "how.2.body": {
    ko: "관심 있는 주제를 고르면 비슷한 관심사를 가진 회원과 바로 연결돼요. AI 매칭을 쓰면 더 잘 맞는 상대를 골라드려요.",
    en: "Pick a topic you're into and get connected right away with a member who shares it — or let AI Match find your best fit.",
    es: "Elige un tema que te guste y conecta enseguida con un miembro que lo comparta, o deja que el Match con IA encuentre tu mejor opción.",
    zh: "选择你感兴趣的话题，立刻与同样喜欢它的会员连线，也可以让AI匹配为你找到最合拍的人。",
    ja: "好きなトピックを選べば、同じ関心を持つメンバーとすぐにつながります。AIマッチなら、より相性の良い相手を選んでくれます。",
  },
