...
const translations = {
  ...
  "hero.trust3": { ko: "애플·구글 간편 로그인", en: "Sign in with Apple or Google", es: "Inicia sesión con Apple o Google", zh: "支持Apple、谷歌快捷登录", ja: "Apple・Googleで簡単ログイン" },
  ...
  "how.1.body": {
    ko: "애플, 구글, 이메일 중 편한 방법으로 가입하고 프로필을 완성하세요.",
    en: "Sign up with Apple, Google, or email — whichever's easiest — then finish your profile.",
    es: "Regístrate con Apple, Google o correo, el que prefieras, y completa tu perfil.",
    zh: "选择Apple、谷歌或邮箱注册，完善你的个人主页。",
    ja: "Apple、Google、メールの好きな方法で登録し、プロフィールを完成させましょう。",
  },
  ...
  "shop.explainerPremium.body": {
    ko: "구독하는 동안 계속 적용되는 혜택이에요 — 무제한 스와이프, 나를 좋아요한 사람 보기, 고급 필터를 계속 쓸 수 있어요.",
    en: "An ongoing subscription — unlimited swipes, see who liked you, and advanced filters for as long as you're subscribed.",
    es: "Una suscripción continua — swipes ilimitados, ver quién te dio like y filtros avanzados mientras estés suscrito.",
    zh: "持续生效的订阅——订阅期间可无限滑动、查看谁喜欢了你、使用高级筛选。",
    ja: "継続的なサブスクリプションです — 契約中は無制限スワイプ、いいねしてくれた人の確認、詳細フィルターがずっと使えます。",
  },
  "shop.explainerSuperlike.title": { ko: "슈퍼좋아요", en: "Super Like", es: "Super Like", zh: "超级喜欢", ja: "スーパーいいね" },
  "shop.explainerSuperlike.body": {
    ko: "특정 한 사람에게 쓰는 1회성 아이템이에요 — 상대방 화면에 하이라이트로 표시돼서 일반 좋아요보다 눈에 잘 띄어요.",
    en: "A one-time boost for one person — they'll see you highlighted, so you stand out from a regular like.",
    es: "Un impulso único para una persona — verá tu perfil resaltado, así destacas frente a un like normal.",
    zh: "用于某一个人的一次性道具——对方会看到你被高亮显示，比普通喜欢更显眼。",
    ja: "特定の一人に使う1回限りのアイテムです — 相手の画面でハイライト表示され、通常のいいねより目立ちます。",
  },
  "shop.explainerBoost.title": { ko: "부스트", en: "Boost", es: "Boost", zh: "曝光加速", ja: "ブースト" },
  "shop.explainerBoost.body": {
    ko: "내 프로필을 위한 1회성 아이템이에요 — 30분 동안 모든 사람의 디스커버 피드 맨 위에 노출돼요.",
    en: "A one-time boost for you — your profile jumps to the top of everyone's Discover feed for 30 minutes.",
    es: "Un impulso único para ti — tu perfil salta al principio del feed de Descubrir de todos durante 30 minutos.",
    zh: "用于你自己资料的一次性道具——30分钟内置顶显示在所有人的发现页面。",
    ja: "自分のプロフィール用の1回限りのアイテムです — 30分間、みんなの「見つける」フィードの上位に表示されます。",
  },

  "shop.product.superlike_pack_5.name": { ko: "슈퍼좋아요 5개", en: "Super Like x5", es: "5 Super Likes", zh: "超级喜欢 x5", ja: "スーパーいいね ×5" },
  "shop.product.superlike_pack_5.desc": {
    ko: "마음에 드는 상대에게 특별하게 눈에 띄어보세요.",
    en: "Stand out to someone you like.",
    es: "Destaca ante alguien que te gusta.",
    zh: "让心仪的人一眼注意到你。",
    ja: "気になる相手に目立ってアピールできます。",
  },
  "shop.product.superlike_pack_20.name": { ko: "슈퍼좋아요 20개", en: "Super Like x20", es: "20 Super Likes", zh: "超级喜欢 x20", ja: "スーパーいいね ×20" },
  "shop.product.superlike_pack_20.desc": {
    ko: "마음에 드는 상대에게 특별하게 눈에 띄어보세요.",
    en: "Stand out to someone you like.",
    es: "Destaca ante alguien que te gusta.",
    zh: "让心仪的人一眼注意到你。",
  ...
  "shop.product.boost_1.name": { ko: "부스트 1회", en: "Boost x1", es: "1 Boost", zh: "曝光加速 x1", ja: "ブースト ×1" },
  "shop.product.boost_1.desc": {
    ko: "30분 동안 디스커버 피드 맨 위에 노출돼요.",
    en: "Top of the Discover feed for 30 minutes.",
    es: "Al principio del feed de Descubrir durante 30 minutos.",
    zh: "30分钟内置顶显示在“发现”页面。",
    ja: "30分間「見つける」フィードの上位に表示されます。",
  },
  ...
  "shop.product.membership_monthly.desc": {
    ko: "무제한 스와이프, 나를 좋아요한 사람 보기, 고급 필터까지 — 매달 자동 갱신돼요.",
    en: "Unlimited swipes, see who liked you, and advanced filters — renews monthly.",
    es: "Swipes ilimitados, ve quién te dio like y filtros avanzados — se renueva cada mes.",
    zh: "无限滑动、查看谁喜欢了你、高级筛选——每月自动续费。",
    ja: "無制限スワイプ、いいねしてくれた人の確認、詳細フィルターなど — 毎月自動更新されます。",
  },
  ...
  "shop.product.membership_yearly.desc": {
    ko: "무제한 스와이프, 나를 좋아요한 사람 보기, 고급 필터까지 — 매년 자동 갱신되고 월간 결제보다 저렴해요.",
    en: "Unlimited swipes, see who liked you, and advanced filters — renews yearly, cheaper than paying monthly.",
