...
const translations = {
  ...
  "feature.8.body": {
    ko: "프로필에 MBTI를 등록하면, AI 매칭이 관심사·나이·거리와 함께 MBTI 궁합까지 살펴서 나와 가장 잘 맞는 인증된 회원을 골라줘요. MBTI를 모른다면 앱 안에서 바로 성향 테스트를 받을 수 있어요.",
    en: "Add your MBTI to your profile and AI Match weighs MBTI compatibility alongside interests, age and distance to pick the verified member who suits you best. Don't know your type? Take the in-app quiz.",
    es: "Añade tu MBTI a tu perfil y el Match con IA valora la compatibilidad MBTI junto con intereses, edad y distancia para elegir al miembro verificado que mejor te encaja. ¿No sabes tu tipo? Haz el test dentro de la app.",
    zh: "在个人资料中填写你的MBTI，AI匹配会综合兴趣、年龄、距离和MBTI契合度，为你挑选最合拍的认证会员。不知道自己的MBTI？在应用内直接测试即可。",
    ja: "プロフィールにMBTIを登録すると、AIマッチが興味・年齢・距離に加えてMBTIの相性も見て、あなたに最も合う認証済みメンバーを選びます。MBTIが分からない方は、アプリ内ですぐに診断テストを受けられます。",
  },
